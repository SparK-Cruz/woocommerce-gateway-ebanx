...
<div id="ebanx-payment-data">
    ...
    <fieldset id="wc-ebanx-cc-form" class="wc-credit-card-form wc-payment-form">
        <p class="form-row form-row-wide">
            ...
            <input id="ebanx-card-number" class="input-text wc-credit-card-form-card-number" inputmode="numeric" autocomplete="cc-number" autocorrect="no" autocapitalize="no" spellcheck="no" placeholder="&bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull;" type="tel" required />
        </p>
        <p class="form-row form-row-first">
            <label for="ebanx-card-expiry"><?php _e( 'Expiration Date (MM / YY)', 'woocommerce-gateway-ebanx' ); ?> <span class="required">*</span></label>            <input id="ebanx-card-expiry" class="input-text wc-credit-card-form-card-expiry" inputmode="numeric" autocomplete="cc-exp" autocorrect="no" autocapitalize="no" spellcheck="no" placeholder="<?php _e( 'MM / YY', 'woocommerce-gateway-ebanx' ); ?>" type="tel" required />
        </p>
        <p class="form-row form-row-last">
        <label for="ebanx-card-cvv"><?php _e( 'Security Code', 'woocommerce-gateway-ebanx' ); ?> <span class="required">*</span></label>
        <input id="ebanx-card-cvv" class="input-text wc-credit-card-form-card-cvc" inputmode="numeric" autocomplete="off" autocorrect="no" autocapitalize="no" spellcheck="no" maxlength="4" placeholder="<?php _e( 'CVC', 'woocommerce-gateway-ebanx' ); ?>" style="width:100px" type="tel" required />
        </p>
        <div class="clear"></div>
    </fieldset>
</div></div>